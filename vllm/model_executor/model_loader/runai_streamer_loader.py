...
from vllm.transformers_utils.runai_utils import list_safetensors as runai_list_safetensors, is_runai_obj_uri
...
class RunaiModelStreamerLoader(BaseModelLoader):
    ...
    def _prepare_weights(self, model_name_or_path: str,
        ...
        hf_folder = (model_name_or_path if
                     (is_local or is_object_storage_path) else download_weights_from_hf(
                         model_name_or_path,
        ...
        hf_weights_files = runai_list_safetensors(path=hf_folder)
