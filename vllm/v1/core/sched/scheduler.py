...
class Scheduler(SchedulerInterface):
    ...
    def schedule(self) -> SchedulerOutput:
        ...
        if self.running:
            ...
            # Identify requests in KV transfer state (WAITING_FOR_REMOTE_KVS)
            # that still hold block references for common prefix calculation
            transferring_request_ids = {
                ...
                any(self.kv_cache_manager.get_blocks(
                    req_id).get_block_ids())  # Has blocks allocated
            }

            num_common_prefix_blocks = (
                self.kv_cache_manager.get_num_common_prefix_blocks(
                    any_request,
                    running_request_ids | transferring_request_ids))
